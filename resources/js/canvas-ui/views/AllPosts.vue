    ...
    <section>
        ...
        <div v-if="isReady" class="mt-5">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12 mt-3">
                <h1 class="font-serif">My blog</h1>
                <p class="lead text-secondary">Here you can expect posts about being a student, working as a part-time student and new things im learning.</p>
